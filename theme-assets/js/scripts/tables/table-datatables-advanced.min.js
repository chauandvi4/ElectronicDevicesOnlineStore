...
function filterColumn(a, e) {
  if (5 == a) {
    var t = $(".start_date").val(),
      l = $(".end_date").val();
    "" !== t && "" !== l && filterByDate(a, t, l),
      $(".dt-advanced-search").dataTable().fnDraw();
  } else
    $(".dt-advanced-search").DataTable().column(a).search(e, !1, !0).draw();
}
var separator = " - ",
      ...
      $(".dt-column-search thead tr:eq(1) th").each(function (a) {
        ...
        $(this).html(
          ...
          $("input", this).on("keyup change", function () {
            s.column(a).search() !== this.value &&
              s.column(a).search(this.value).draw();
          });
      });
    var s = e.DataTable({
