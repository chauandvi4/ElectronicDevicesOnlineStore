$(function () {
  ...
  var a = $(".invoice-list-table"),
    ...
    s = "app-invoice-add.html",
    n = "app-invoice-edit.html";
  if (
    ("laravel" === $("body").attr("data-framework") &&
      ((t = $("body").attr("data-asset-path")),
      (e = t + "app/invoice/preview"),
      (s = t + "app/invoice/add"),
      (n = t + "app/invoice/edit")),
    $(".nextYear").text(new Date().getFullYear() + 1),
    a.length)
  )
    a.DataTable({
      ajax: t + "data/invoice-list.json",
      autoWidth: !1,
      columns: [
        { data: "responsive_id" },
        { data: "invoice_id" },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (a, t, e, s) {
            ...
            return (
              ...
              feather.icons[o[n].icon].toSvg({ class: "avatar-icon" }) +
              "</span></div></span>"
            );
          },
        },
        {
          ...
          render: function (a, e, s, n) {
            var i = s.client_name,
              ...
              c = (i = s.client_name).match(/\b\w/g) || [];
            if (((c = ((c.shift() || "") + (c.pop() || "")).toUpperCase()), l))
              var d =
                '<img src="' +
                t +
                "images/avatars/" +
            ...
            else d = '<div class="avatar-content">' + c + "</div>";
            return (
              '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar' +
              ("" === l ? " bg-light-" + r + " " : " ") +
              'me-50">' +
              d +
              '</div></div><div class="d-flex flex-column"><span class="user-name fw-bold text-truncate">' +
              i +
        ...
        },
        {
          ...
          width: "130px",
          render: function (a, t, e, s) {
            var n = new Date(e.due_date);
            return (
              '<span class="d-none">' +
              moment(n).format("YYYYMMDD") +
              "</span>" +
        ...
        { targets: 7, visible: !1 },
        {
          ...
          render: function (a, t, s, i) {
            return (
              ...
              '</a><div class="dropdown"><a class="btn btn-sm btn-icon px-0" data-bs-toggle="dropdown">' +
      ...
      order: [[1, "desc"]],
      dom: '<"row d-flex justify-content-between align-items-center m-1"<"col-lg-6 d-flex align-items-center"l<"dt-action-buttons text-xl-end text-lg-start text-md-end text-start "B>><"col-lg-6 d-flex align-items-center justify-content-lg-end flex-wrap pe-lg-1 p-0"f<"invoice_status ms-2">>>t<"d-flex justify-content-between mx-2 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      language: {
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (a) {
              return "Details of " + a.data().client_name;
            },
          }),
          type: "column",
