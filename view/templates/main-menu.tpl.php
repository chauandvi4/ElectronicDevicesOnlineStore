        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="../../../html/ltr/horizontal-menu-template/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text mb-0">Bach Khoa Store</h2>
                    </a></li>
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="dropdown nav-item active" data-menu="dropdown">
                    <a class=" nav-link d-flex align-items-center" href="/">
                        <i class="fas fa-solid fa-home "></i><span data-i18n="Dashboards">Home</span>
                    </a>

                </li>

                <li class="dropdown nav-item active" data-menu="dropdown">
                    <a class=" nav-link d-flex align-items-center" href="/blog.php">
                        <i class="fas fa-rss"></i></i><span data-i18n="Dashboards">Blogs</span>
                    </a>
