                                ...
                                <div class="mb-1">
                                    <validation-provider rules="required" v-slot="{ errors }">
                                        ...
                                        <input
                                            ...
                                            name="full name" placeholder="john doe"
                                ...
                                <div class="mb-1">
                                    <validation-provider rules="required|email" v-slot="{ errors }">
                                        ...
                                        <input
                                            ...
                                            type="text" class="form-control" id="register-email"
                                    ...
                                    <validation-provider rules="required" v-slot="{ errors }">
                                        <div class="form-check">
                                            <input
                                                ...
                                                name="agree"
                                                class="form-check-input" type="checkbox" id="register-privacy-policy" tabindex="4" />
